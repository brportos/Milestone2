...
def write_maze(
    ...
    """Writes the generated maze grid, coordinates, and solution path to a file.
    ...
    Args:
        grid (list[list[int]]): 2D array representing wall bitmasks for each cell.
        entry (tuple[int, int]): Starting coordinates (x, y) of the maze.
        exit (tuple[int, int]): Target coordinates (x, y) of the maze.
        path (str): Sequence of direction steps (e.g., "NNEESW") solving the maze.
